...
function Map3.setup(ctx)
    ...
    m3HpBillboard.Size = UDim2.new(0, 140, 0, 28)
    ...
    m3HpFill.Position = UDim2.new(0, 2, 0, 2)
    ...
    m3HpText.Size = UDim2.new(1, 0, 1, 0)
    ...
    m3LabelBillboard.Size = UDim2.new(0, 200, 0, 24)

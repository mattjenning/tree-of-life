...
function Map2.setup(ctx)
    ...
    m2HpBillboard.Size = UDim2.fromOffset(140, 28)
    ...
    m2HpBg.Size = UDim2.fromScale(1, 1)
    ...
    m2HpText.Size = UDim2.fromScale(1, 1)
    ...
    m2LabelBillboard.Size = UDim2.fromOffset(200, 24)

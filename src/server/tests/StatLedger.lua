...
Tests.test("StatLedger.recordDamage — accumulates per-tower per-type", function()
    StatLedger.reset()
...
Tests.test("StatLedger.recordDamage — unknown hitType counts as direct", function()
    StatLedger.reset()
...
Tests.test("StatLedger.recordDamage — ignores nil tower or non-positive amount", function()
    StatLedger.reset()
...
Tests.test("StatLedger.recordSlow — slow-value = (1-mult) * duration", function()
    StatLedger.reset()
...
Tests.test("StatLedger.recordPlacement — counts (type, rarity) pairs", function()
    StatLedger.reset()
...
Tests.test("StatLedger.reset — clears all state", function()
    StatLedger.reset()
